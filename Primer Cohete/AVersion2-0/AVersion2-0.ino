//Utiliza la biblioteca SFE_BMP180
//75% de almacenamiento
//76% de memoria dinámica
//Error con la altura
...
double temperature,pressure,altura;
double promPressure;                //Promedio de presion
//-->Formula barometrica
    double Po = 101325;             //Presión al nivel del mar [Pa]
    double M = 0.02896;             //Masa molar del aire [kg/mol]
    double TempK;                   //Temperatura en grados kelvin
    double R = 8.3143;              //Constante universal de los gases [(N*m)/(mol*K)]
    double g = 9.807;               //Aceleración gravitacional [m/s^2]
//-->Alturas para el cálculo de la media móvil
    double altura1,altura2,altura3,altura4,altura5,altura6,altura7,altura8;
    double alturaMediaMovil = 0;
    double alturaPendiente = 0;
//-->Ultimos 2 valores de la altura media movil
    double AMM1 = alturaMediaMovil;
    double AMM2;
