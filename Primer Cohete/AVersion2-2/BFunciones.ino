...
void registroDatos()
{
  ...
  if(archivo){
      dataString += String(numeroLectura)+","+String(millis())+",TIEMPO,"+String(alturaMediaMovil)+","+String(aceleracionX)+","+String(aceleracionY)+","+String(aceleracionZ)+",";
      archivo.print(dataString);
      dataString = "";
      dataString += String(magnetometroX)+","+String(magnetometroY)+","+String(magnetometroZ)+","+String(giroscopioX)+","+String(giroscopioY)+","+String(giroscopioZ)+",ESTADO,LONGITUD,LATITUD,ALTURAGPS";
...
//*********************************************************************************************************************************************************************************************
void leerBarCali(){
archivo = SD.open("BarCali.txt");
if(archivo){
  while(archivo.available()){
    lecturaCaracter = archivo.read();
    if(lecturaCaracter != ','){
      lecturaString += lecturaCaracter;
    }
    else{
      switch(numeroVariable){
        case 1:
        ac1 = lecturaString.toInt();
        break;
        case 2:
        ac2 = lecturaString.toInt();
        break;
        case 3:
        ac3 = lecturaString.toInt();
        break;
        case 4:
        ac4 = lecturaString.toInt();
        break;
        case 5:
        ac5 = lecturaString.toInt();
        break;
        case 6:
        ac6 = lecturaString.toInt();
        break;
        case 7:
        b1 = lecturaString.toInt();
        break;
        case 8:
        b2 = lecturaString.toInt();
        break;
        case 9:
        mb = lecturaString.toInt();
        break;
        case 10:
        mc = lecturaString.toInt();
        break;
        case 11:
        md = lecturaString.toInt();
        break;
        case 12:
        b5 = atol(lecturaString.c_str());
        break;
      }
      lecturaString = "";
