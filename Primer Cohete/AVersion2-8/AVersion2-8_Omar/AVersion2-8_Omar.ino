...
//89% de almacenamiento
//78% de memoria dinámica
//La configuración está en un archivo diferente
//Media movil vectorizada
//45 lecturas
//Gyro y Magnetometro arreglando
...
//Conexiones Módulo MicroSD      Conexiones IMU: GY-80       Conexiones Relevador      Conexiones GPS
//   GND ---> GND                  3.3V ---> Vcc                  D8 ---> IN            3.3V ---> Vcc
//    5V ---> Vcc                   GND ---> GND                 GND ---> GND            GND ---> GND
...
#include <GPSport.h>     //Dentro del archivo se utiliza la libreria NeoSWSerial.h, que solo trabaja con 9600, 19200 o 38400 baud
        ...
        //--------GPS---------
NMEAGPS gps;                        //Analiza los caracteres del GPS
gps_fix fix;                        //Mantiene los últimos valores                   
/////////////////////////////////////////DEFINICIONES/////////////////////////////////////////
        //--------Micro SD---------
