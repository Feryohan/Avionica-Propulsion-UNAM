...
//  Serial.println("inicializacion correcta"); 
  ...
  /*  for(int i = 0; i < 5; i++) {
    ...
    */
        archivo.println("Dato,Millis,AejeX,AejeY,AejeZ,GejeX,GejeY,GejeZ,MejeX,MejeY,MejeZ");
    for (int i = 1; i < 120; i++){
...
*/
  ...
  ///////////////////////// Lectura de los datos en la micro SD /////////////////////////
