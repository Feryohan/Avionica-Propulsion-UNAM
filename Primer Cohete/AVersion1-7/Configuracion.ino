...
void setup() 
{
  ...
  SD.remove("datos.txt");                      //Borra el documento "datos" de la micro SD
  archivo = SD.open("datos.txt", FILE_WRITE);  //Crea el documento "datos" en la micro SD
